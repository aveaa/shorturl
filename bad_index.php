...
if(substr($_POST['url-shorter'],0,8) != 'https://'){
	...
	$result->execute();
	echo "<p class='alert alert-success text-center'>Твой URL готов</p>";
	...
	echo $error;
			...
			?>
				...
				<div class="form-group">
					...
					<p>Пожалуйста, не пишите с http:// или https://</p>
				</div>
				<input type="submit" name="submit" placeholder="Вставьте ссылку для сокращения..">
				</form>
			</div>
